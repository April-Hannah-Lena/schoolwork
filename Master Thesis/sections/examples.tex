...
\subsubsection{An Initial Numerical Experiment}
...
\subsubsection{The Adjoint of $H^2 (A)$}
...
This example leads to a fundamental question in the study of operator theoretic dynamics, 
wihch was already hinted toward in the example of the Duffing equation. When the 
...
\todo{talk about ways to answer the question: stochastic spectrum collapse, rigged DMD}
