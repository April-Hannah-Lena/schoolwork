...
\begin{figure}[ht!]
    ...
    \makebox[\linewidth][c]{
        \begin{subfigure}[t]{0.4\textwidth}
            \includegraphics[width=0.95\textwidth]{times_simple.pdf}
            \caption{Times for a "simple" map, $k = 10$.}
            \label{fig:times:simple}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.4\textwidth}
            \includegraphics[width=0.95\textwidth]{times_medium.pdf}
            \caption{Times for an "average" map, $k = 100$.}
            \label{fig:times:med}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.4\textwidth}
            \includegraphics[width=0.95\textwidth]{times_complex.pdf}
            \caption{Times for a "complex" map, $k = 1000$.}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\textwidth]{times_steps_loglog.pdf}
    \caption{Log-Log plot of number of steps $k$ vs time ($s$), where $N = 400$ is constant.}
    \label{fig:steps}
\end{figure}
