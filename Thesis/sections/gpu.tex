...
using \jlinl{@muladd p .* r .+ c} where $r$ and $c$ are the box's center and radius, respectively. 
...
As with the CPU kernel, there are some factors only in control fo the user. Modern GPUs 
