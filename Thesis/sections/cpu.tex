...
\begin{jllisting}[float, floatplacement=ht!, language=julia, style=jlcodestyle, label=lst:tuple_vgather, captionpos=b, caption=Conversion function to packed tuples]
...
\begin{jllisting}[float, floatplacement=ht!, language=julia, style=jlcodestyle, label=lst:tuple_vscatter, captionpos=b, caption=Conversion back to single tuples]
